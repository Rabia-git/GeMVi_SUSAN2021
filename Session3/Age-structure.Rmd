---
title: "Age-structured compartmental model"
output:
  html_document: 
    keep_md: yes
...
###### **Main contacts for this notebook: Joe Hilton (joe.hilton@warwick.ac.uk) and rabia Aziza (rabia.aziza@warwick.ac.uk)**
<br>
...
```{r}
I_0 = rep(0, nage)
I_0[7] = 1  # One infected in 7th age class (30 to 35 years old)
S_0 = N - I_0
R_0 = rep(0, nage)
```
...
```{r}
prev_u20 = results[, I_cols[1:4]]  # infecteds in the first four age classes
